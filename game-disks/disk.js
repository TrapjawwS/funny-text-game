const demoDisk = () => ({
    roomId: 'testroom', // the ID of the room the player starts in
    rooms: [
      {
        id: 'testroom', // unique ID for this room
        name: 'Test', // room name (shown when player enters the room)
        // room description (shown when player first enters the room)
        desc:  `This is my funny test game.
        ...
        onLook: () => {
          const room = getRoom('testroom');
          room.desc = `You are currently standing in the test rooom. This is the room where I test all the things in this engine. For example there's a big lump of **CHEESE* hanging above your head.
  
          ***Rooms** form the foundation of the engine's design. At any given time, your player will be standing in one of the rooms you built for them. These can be literal rooms like the te you find yourself in now, or metaphorical rooms like **The End of Time** or **A Dream**.
